...
#
#
# obj = MyClass()  # tworzenie instancji klasy (obiektu)
# obj.my_method("A")  # wywołanie metody (zachowania) my my_method na obiekcie obj klasy MyClass
# obj.my_method(1)
# obj.my_method(2)
...
# class MyClass:
#     def __init__(self, name): # konstruktor bez bezparametrowy
